  ...
  return (
    <main className="min-h-screen bg-[#121212] px-3 py-5 sm:p-6">
      <div className="mx-auto max-w-[1520px] space-y-6">
        <section className="overflow-hidden rounded-[28px] border border-white/[0.06] bg-[radial-gradient(circle_at_top_left,rgba(198,180,139,0.10),transparent_34%),linear-gradient(180deg,#1b1b1b_0%,#141414_100%)] p-5 sm:p-6">
          <div className="flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between">
            <div className="max-w-[760px] min-w-0">
              <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-[#c6b48b]/70">Réseau commercial</p>
...
function Purpose({ icon, title, detail }: { icon: React.ReactNode; title: string; detail: string }) {
  return (
    <div className="min-w-0 rounded-2xl border border-white/[0.07] bg-black/20 p-4">
      <div className="flex items-center gap-2 text-[#c6b48b]">{icon}<p className="text-[11px] font-semibold text-white">{title}</p></div>
